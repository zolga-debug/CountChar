...
//      Der für uns im Moment interessante Bereich.
		...
		System.out.println(1+3+"Hallo"+" "+"Welt"+4+5);  //Vermutung: 4Hallo9 => 4Hallo45
		System.out.println(1+3+"Hallo"+" "+"Welt"+(4+5));
		System.out.println(5*(6-5)*2); //Prio.-Änderung
		System.out.println(""+1+2+3); // 123 Tricky:
